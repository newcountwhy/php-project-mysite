...
class Upload extends CI_Controller
{
    ...
    public function do_upload() {
		...
		if ( ! $this->upload->do_upload('userfile')) {
			...
			$this->load->view('template/footer');
			header('Location: https://infs3202-5f6dbbea.uqcloud.net/m3/write_review');
        }
	}
	public function watermark(){
		header('Location: https://infs3202-5f6dbbea.uqcloud.net/m3/index.php/manipulation_controller');
	}
